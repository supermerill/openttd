...
static const Action5Type _action5_types[] = {
	...
	/* 0x04 */ { A5BLOCK_ALLOW_OFFSET, SPR_SIGNALS_BASE,             1, PRESIGNAL_SEMAPHORE_AND_PBS_SPRITE_COUNT,    "Signal graphics"          }, //TODO: PRESIGNAL_SEMAPHORE_PBS_YELLOW_SPRITE_COUNT
