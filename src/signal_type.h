...
enum SignalType {
	...
	SIGTYPE_PBS_WEAK   = 6, ///< normal pbs signal

	SIGTYPE_END,
	SIGTYPE_LAST       = SIGTYPE_PBS_WEAK,
...
enum SignalState {
	...
	SIGNAL_STATE_YELLOW = 2, ///< The signal is yellow, only for pbs signals
	/* signal num 3 is possible for pbs signals, not used yet */
};
