...
{
//TODO: remove #define MAYBE_DRAW_SIGNAL(x, y, z, t) if (IsSignalPresent(tile, x)) DrawSingleSignal(tile, rti, t, GetSingleSignalState(tile, x), y, z)
#define MAYBE_DRAW_SIGNAL(x, y, z, t) if (IsSignalPresent(tile, x)) DrawSingleSignal(tile, rti, t, IsPbsSignal(GetSignalType(tile, t)) ? GetSignalStateByTrackdir(tile, TrackToTrackdir(t)) : GetSingleSignalState(tile, x), y, z)
...
static TrackStatus GetTileTrackStatus_Track(TileIndex tile, TransportType mode, uint sub_mode, DiagDirection side)
{
	...
	switch (GetRailTileType(tile)) {
		...
		case RAIL_TILE_SIGNALS: {
			...
			/* The signal state is stored differently for PBS signals.
			 * If the state for a track is not red, set all state bits
			 * for the track causing the signal to be seen as green.
			 * As PBS signals are always in just one trackdir, this
			  * causes no problems further down. */
			if (IsPbsSignal(GetSignalType(tile, TRACK_UPPER)) && (b & SignalOnTrack(TRACK_UPPER)) != 0) b |= SignalOnTrack(TRACK_UPPER);
			if (IsPbsSignal(GetSignalType(tile, TRACK_LOWER)) && (b & SignalOnTrack(TRACK_LOWER)) != 0) b |= SignalOnTrack(TRACK_LOWER);
			...
			static const StringID signal_type[7][7] = {
				{
					...
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NORMAL_PBSWEAKSIGNALS
				},
				{
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NORMAL_PRESIGNALS,
					...
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PBSWEAKSIGNALS
				},
				{
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NORMAL_EXITSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PRE_EXITSIGNALS,
					...
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_EXIT_PBSWEAKSIGNALS
				},
				{
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NORMAL_COMBOSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PRE_COMBOSIGNALS,
					...
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_COMBO_PBSWEAKSIGNALS
				},
				{
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NORMAL_PBSSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PRE_PBSSIGNALS,
				...
				},
				{
					...
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NOENTRY_PBSWEAKSIGNALS
				},
				{
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NORMAL_PBSWEAKSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PRE_PBSWEAKSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_EXIT_PBSWEAKSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_COMBO_PBSWEAKSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PBS_PBSWEAKSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_NOENTRY_PBSWEAKSIGNALS,
					STR_LAI_RAIL_DESCRIPTION_TRACK_WITH_PBSWEAKSIGNALS
				}
			};
